...
class RadPathModel(nn.Module):
    def __init__(self):
        super(RadPathModel, self).__init__()
        self.omic_sizes = [14, 18, 75, 279, 744, 768]
    ...
    def forward(self, **kwargs):
        ...
        h_path_coattn, _ = self.coattn(h_omic_bag, h_path_bag, h_path_bag)
        return h_path_coattn, h_omic_bag
